...
export class ProvisionStack extends Stack {
  constructor(scope: Construct, id: string, props: ProvisionStackProps) {
    ...
    let { ambHttpEndpoint, contractAddress } = props;
...
`);
      ...
      bundling: {
        commandHooks: {
          afterBundling(inputDir: string, outputDir: string): string[] {
            return [`cp -r ${inputDir}/lambda/contracts ${outputDir}`];
          },
    ...
    const createAccount = new lambdaNodejs.NodejsFunction(
      this,
      "CreateAccount",
      {
        ...defaultFuncProps,
    ...
    const createItemJob = new lambdaNodejs.NodejsFunction(
      this,
      "CreateItemJob",
      {
        ...defaultFuncProps,
    ...
    const listOnMarketplaceJob = new lambdaNodejs.NodejsFunction(
      this,
      "ListOnMarketplaceJob",
      {
        ...defaultFuncProps,
    ...
    const listOnMarketplace = new lambdaNodejs.NodejsFunction(
      this,
      "ListOnMarketplace",
      {
        ...defaultFuncProps,
    ...
    const removeFromMarketplaceJob = new lambdaNodejs.NodejsFunction(
      this,
      "RemoveFromMarketplaceJob",
      {
        ...defaultFuncProps,
    ...
    const removeFromMarketplace = new lambdaNodejs.NodejsFunction(
      this,
      "RemoveFromMarketplace",
      {
        ...
        environment: {
          REMOVE_FROM_MARKETPLACE_JOB_NAME:
            removeFromMarketplaceJob.functionName,
          ...defaultFuncEnvironments,
        },
      }
    );
    ...
    const createUploadUrl = new lambdaNodejs.NodejsFunction(
      this,
      "CreateUploadUrl",
      {
        ...defaultFuncProps,
